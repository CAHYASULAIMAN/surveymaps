...
// mbil 10 data  terminal terbaru dari 1 bulan terakhir yang di update
$sql = "SELECT nama, latitude, longitude, cluster, updated_at 
        FROM terminals 
        WHERE MONTH(updated_at) = '$sekarang' 
          AND YEAR(updated_at) = '$sebulan_teknis'
        ORDER BY updated_at DESC 
        LIMIT 5";

$result_terminal = $koneksi->query($sql);
...
// ambil data pelanggan yang dibuat hari ini
$sql = "SELECT nama, sales,  status_survey FROM pelanggan WHERE DATE(tanggal_input) = ?";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dashboard_teknis.php">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $total_teknis_bulan ?> survey</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Terminal Diperbarui Dalam Sebulan Terakhir </h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php if ($result_terminal->num_rows > 0): ?>
                                                    <?php while($row = $result_terminal->fetch_assoc()): ?>
                                                        <tr>
                                                ...
                                                <?php else: ?>
                                                    <tr>
                                                        <td colspan="4" class="text-center text-muted">Tidak ada terminal yang diperbarui dalam sebulan terakhir</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
